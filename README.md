...
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240214150332.png)
...
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20230113115226.png)

2.点击`configure`设置visual studio的版本，和64位应用程序
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240131153911.png)
...
### 三、VScode+cmake插件编译
1.选择编译套件
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240131165800.png)

![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240131165840.png)

2.编译
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240131165915.png)

3.运行
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240131165954.png)


## 程序运行说明

编译成功后再运行你会看到如下的程序运行界面：
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20240131170422.png)
...
其中红色的线为外轮廓，绿色的线为内轮廓。
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20230113205512.png)
![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20230113203242.png)

![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20230113203022.png)

![image.png](https://github.com/sunxvming/navmesh/blob/master/img/20230113203058.png)
